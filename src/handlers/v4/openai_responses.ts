...
import { openAiResponsesTransformer } from "../../transformers/openai_responses";
...
export async function handleOpenAiResponses(
  ...
  const outboundPayload = openAiResponsesTransformer.transformClientToWire(body, directive, req.headers);
...
export const handleV4OpenAIResponses = handleOpenAiResponses;
